...
var NFC = (function (_super) {
     ...
     * Read MiFare Card
     *
     * @param {json} jsonMessage
     */
    NFC.prototype.readMF = function (jsonMessage) { return; };
    ;
    /**
     * Write MiFare Card
     *
     * @param {json} jsonMessage
     */
    NFC.prototype.writeMF = function (jsonMessage) { return; };
    ;
    /**
    ...
    /**
       * Read NFC tags sending the tag data to the success callback.
       */
    NFC.prototype.readerMode = /**
       * Read NFC tags sending the tag data to the success callback.
       */
    function (flags, readCallback, errorCallback) { return; };
    NFC.decorators = [
        { type: Injectable },
    ];
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:returntype", Promise)
    ], NFC.prototype, "makeReadOnly", null);
    __decorate([
        Cordova(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Array]),
    ...
    ], NFC.prototype, "readMF", null);
    __decorate([
        Cordova(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [String]),
        __metadata("design:returntype", Promise)
    ], NFC.prototype, "writeMF", null);
    __decorate([
      Cordova(),
      __metadata("design:type", Function),
      __metadata("design:paramtypes", []),
      __metadata("design:returntype", Promise)
    ], NFC.prototype, "readerMode", null);
    /**
     * @name NFC
     * @description
     * The NFC plugin allows you to read and write NFC tags. You can also beam to, and receive from, other NFC enabled devices.
